...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",R.jsx("a",{href:`mailto:${e.email}`,className:"CommentInfo__email",children:e.email})]}),R.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>R.jsx("div",{className:"CommentList",children:e.map(t=>R.jsx(Pc,{comment:t},t.id))}),Tc=({name:e,email:t})=>R.jsx("a",{className:"UserInfo",href:`mailto:${t}`,children:e}),Mc=({title:e,body:t,comments:i,user:n})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Tc,{name:n.name,email:n.email})]})]}),R.jsx("p",{className:"PostInfo__body",children:t}),i.length===0?R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}):R.jsx(Lc,{comments:i})]}),Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{title:t.title,user:t.user,body:t.body,comments:t.comments},t.id))});function Dc(e){return Nc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.postId===e)||[]}const Oc=Cc.map(e=>({...e,comments:jc(e.id),user:Dc(e.userId)})),Fc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(R.jsx(Fc,{}));
